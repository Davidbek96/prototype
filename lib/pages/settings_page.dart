  ...
  Widget build(BuildContext context) {
    ...
    return PopScope<Object?>(
      ...
      onPopInvokedWithResult: (bool didPop, Object? result) {
        // If the pop actually happened, clear the API key input.
        // We check didPop to avoid clearing when the pop was prevented.
        if (didPop) {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              // prefer current controller text, fallback to stored key
                              final controllerText = settings
                                  .apiKeyController
                                  .text
                                  .trim();
                              final text = controllerText.isNotEmpty
                                  ? controllerText
                      ...
                      // Reactive TextField so obscureText toggles immediately
                      Obx(
                        () => TextField(
                              ...
                              children: [
                                ...
                                Obx(() {
                                  if (settings.isSaving.value) {
                                    // small spinner to indicate validation in progress
                                    return Padding(
